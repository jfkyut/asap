...
<template>
    <div :class="!route().current().includes('dashboard') ? 'pt-16' : ''" class="bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 min-h-screen pb-24 p-2 select-none text-xs">
        <!-- header -->
